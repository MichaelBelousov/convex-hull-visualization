...
var author$project$KeyUpPorts$keyUp = _Platform_incomingPort('keyUp', elm$json$Json$Decode$value);
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$KeyUpPorts$keyUp(author$project$Main$KeyUp)
			]));
};
